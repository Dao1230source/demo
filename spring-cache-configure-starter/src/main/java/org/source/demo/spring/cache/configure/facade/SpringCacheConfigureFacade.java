package org.source.demo.spring.cache.configure.facade;

import com.github.benmanes.caffeine.cache.Cache;
import lombok.extern.slf4j.Slf4j;
import org.source.demo.spring.cache.configure.facade.mapper.StudentMapper;
...
public class SpringCacheConfigureFacade {
     ...
     */
    @ConfigureCache(cacheNames = "str2ViewListJvmIntegerKey", key = "#ids", cacheKeySpEl = "#P.id",
    ...
    @ConfigureCache(cacheNames = "partialCacheStrategyTrust", key = "#names", cacheKeySpEl = "#P.name",
